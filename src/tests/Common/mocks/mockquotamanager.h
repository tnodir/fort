...
protected:
    MOCK_METHOD(qint32, quotaAlerted, (QuotaManager::AlertType alertType), (const override));
    MOCK_METHOD(void, setQuotaAlerted, (QuotaManager::AlertType alertType, qint32 v), (override));
};
