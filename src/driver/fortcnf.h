...
#define FORT_DEVICE_BOOT_FILTER   0x0001
#define FORT_DEVICE_STEALTH_MODE  0x0002
#define FORT_DEVICE_FILTER_LOCALS 0x0004
#define FORT_DEVICE_BOOT_CONF_MASK                                                                 \
    (FORT_DEVICE_BOOT_FILTER | FORT_DEVICE_FILTER_LOCALS | FORT_DEVICE_STEALTH_MODE)

#define FORT_DEVICE_TRACE_EVENTS        0x0008
#define FORT_DEVICE_IS_OPENED           0x0010
