...
enum {
    ...
    FORT_IOCTL_INDEX_SETGROUPS,
    FORT_IOCTL_INDEX_SETGROUPFLAG,
...
#define FORT_IOCTL_SETGROUPS    FORT_CTL_CODE(FORT_IOCTL_INDEX_SETGROUPS, FILE_WRITE_DATA)
#define FORT_IOCTL_SETGROUPFLAG FORT_CTL_CODE(FORT_IOCTL_INDEX_SETGROUPFLAG, FILE_WRITE_DATA)
