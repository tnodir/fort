...
public:
    ...
    static quint32 logBlockedIpHeaderSize();
    static quint32 logBlockedIpSize(quint32 pathLen);
    ...
    static void logBlockedHeaderWrite(char *output, bool blocked, quint32 pid, quint32 pathLen);
    ...
    static bool confIpInRange(
            const void *drvConf, quint32 ip, bool included = false, int addrGroupIndex = 0);
    static quint16 confAppFind(const void *drvConf, const QString &kernelPath);
    static quint8 confAppGroupIndex(quint16 appFlags);
    static bool confAppBlocked(const void *drvConf, quint16 appFlags, quint8 *blockReason);
    static quint16 confAppPeriodBits(const void *drvConf, quint8 hour, quint8 minute);

    static bool isTimeInPeriod(quint8 hour, quint8 minute, quint8 fromHour, quint8 fromMinute,
