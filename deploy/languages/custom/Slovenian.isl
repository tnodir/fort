...
NotCompatibleWithWindows=Ta program ni zdruÿljiv z razli—ico sistema Windows (potreben je Windows 10 1809 ali novej’i).
...
InstallVCRedist=Namesti najnovej’i Visual C++ za redistribucijo!
